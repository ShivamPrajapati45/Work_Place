    ...
    return (
        <div className=''>
            ...
            <NextBtn
                state={state}
                handlers={handlers}
                className={'mt-4 px-6 mx-5 w-auto py-1 text-lg font-semibold text-white bg-primary_button rounded-md flex items-center justify-center gap-4 disabled:opacity-50'}
            />
        </div>
    )
}
