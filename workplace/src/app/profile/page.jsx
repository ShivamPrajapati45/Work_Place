        ...
        <>
                {
                    isLoaded && (
                        ...
                        <div className='relative rounded-lg  mx-auto  my-10 flex items-center gap-4 justify-between max-w-[90vw] h-[70vh] min-h-[100%] duration-500 transition-all'>
                                    ...
                                    <>
                                        ...
                                        >
                                            ...
                                            <div 
                                                ...
                                                className='bg-purple-500 cursor-pointer h-20 w-20 flex items-center justify-center rounded-full relative'>
                                                {
                                                    previewImage ?  (
                                                        <img
                                                            src={previewImage}
