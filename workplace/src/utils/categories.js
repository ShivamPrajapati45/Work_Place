export const categories = [
    ...
    {
        name: 'Lifestyle',
        logo: '/images/service-8.svg'
    },
    {
        name: 'Data',
        logo: '/images/service-9.svg'
    },
    {
        name: 'Photography',
...
export const professionOptions = [
    ...
    { value: 'artificial_intelligence_specialist', label: 'AI Specialist' },
    ...
    { value: 'aviation_pilot', label: 'Aviation Pilot' },
    { value: 'flight_attendant', label: 'Flight Attendant' },
    { value: 'marine_biologist', label: 'Marine Biologist' },
